...
export const LOGIN_URL = 'http://localhost:5000/auth/vatsim';
export const PROFILE_URL = 'http://localhost:5000/profile';
export const COUNT_URL = 'http://localhost:5000/data/treatmentCount';
...
export const LOGIN_URL = 'https://ice-backend.lusep.fi/auth/vatsim';
export const PROFILE_URL = 'https://ice-backend.lusep.fi/profile';
export const COUNT_URL = 'https://ice-backend.lusep.fi/data/treatmentCount';
